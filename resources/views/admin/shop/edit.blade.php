    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/admin/shop/update" method="put">
                        <div class="form-group">
                            <label for="shop_name">店舗名</label>
                            <input type="text" class="form-control" id="shop_name" placeholder="店舗名">
                        </div>
                        <div class="form-group">
                            <label for="shop_address">住所</label>
                            <textarea class="form-control" id="shop_address" rows="2"></textarea>
                        </div>

                        <div class="form-group">
                            <label for="shop_open_hour">営業時間</label>
                            <input type="text" class="form-control" id="shop_open_hour" placeholder="09:00〜18:00">
                        </div>
                        <div class="form-group">
                            <label for="shop_close_day">定休日</label>
                            <input type="text" class="form-control" id="shop_close_day" placeholder="毎週水曜日">
                        </div>
                        <div class="form-group">
                            <label for="shop_tel">電話番号</label>
                            <input type="tel" class="form-control" id="shop_tel" placeholder="04712345678">
                        </div>
                        <div class="form-group">
                            <label for="shop_seat_num">座席数</label>
                            <div class="input-group mb-3">
                                <input type="number" class="form-control" id="shop_seat_num" placeholder="10" aria-describedby="shop_seat_num_addon">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <input type="number" class="form-control" id="shop_staff_num" placeholder="10" aria-describedby="shop_staff_num_addon">
                                <div class="input-group-append">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="shop_detail" rows="3"></textarea>
                        </div>
                        <div class="form-group">
                            <label>駐車場</label>
